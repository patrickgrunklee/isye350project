...
print("="*100)
print("PHASE 2: DAILY TIME PERIODS MODEL - 10/3 DAYS-ON-HAND")
print("="*100)
print("\nAPPROACH:")
...
print("  - DoH: International: 10 business days | Domestic: 3 business days")
...
print("\nMonthly aggregation model (10/3 DoH): 7,210 shelves")
print(f"Daily time period model (10/3 DoH):   {total_expansion:,.0f} shelves")
