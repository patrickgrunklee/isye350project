...
print("="*100)
print("PHASE 2: DAILY TIME PERIODS MODEL - 5/2 DAYS-ON-HAND")
print("="*100)
print("\nAPPROACH:")
...
print("\nMonthly aggregation model (5/2 DoH): 6,697 shelves")
print(f"Daily time period model (5/2 DoH):   {total_expansion:,.0f} shelves")
